...
{
    'Player 1 ID': 1157771, 'Player 1 Name': 'Michal Chalupa',
    'Player 2 ID': 577682, 'Player 2 Name': 'Marcel Pikous',
    'P1_ML': 150,
    'P2_ML': -195
},
{
...
EDGE_THRESHOLD_MIN = 0.55
# EDGE_THRESHOLD_MAX = 0.99
ODDS_THRESHOLD_MAX = 3.0
H2H_DISADVANTAGE_THRESHOLD = 0.50
FORM_EQUALITY_BAND = 0
MIN_PLAYER_HISTORY = 1 # Basic check to ensure player exists and has some data
...
#     df_history['Date'] = pd.to_datetime(df_history['Date'])
    ...
    #        "Form Adv": p1_form_advantage > FORM_EQUALITY_BAND
            "Form Adv": p1_form_advantage != 0
        }
    ...
    #        "Form Adv": p2_form_advantage > FORM_EQUALITY_BAND
            "Form Adv": p2_form_advantage != 0
        }
        ...
        print(f"  - Model Edge: {edge_p1:.2%} -> {'PASS' if p1_conditions['Edge Min'] else 'FAIL'}")
        ...
        print(f"  - Model Edge: {edge_p2:.2%} -> {'PASS' if p2_conditions['Edge Min'] else 'FAIL'}")
