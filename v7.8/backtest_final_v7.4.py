...
try:
    ...
    for index, match in tqdm(backtest_df.iterrows(), total=backtest_df.shape[0]):
        ...
        gbm_features = pd.DataFrame([{'Win_Rate_Advantage': win_rate_advantage, 'Pressure_Points_Advantage': pressure_points_advantage}])
    ...
    #            (p1_market_odds < 2 or p1_market_odds > 3.0) and
            ...
            if (win_rate_advantage < 0 and 
    #            h2h_p1_win_rate <= 0.5 and 
    #            (p2_market_odds < 2 or p2_market_odds > 3.0) and
