# CPR Czech Liga Pro Table Tennis Model (V9.0+)
...
Break the full pipeline into chunks with user approval between each:

| Chunk | Scripts | Est. Time | Execution |
|-------|---------|-----------|-----------|
| 1 | advanced_feature_engineering_v7.4.py | ~90 min | Background |
| 2 | merge_data_v7.4.py + remove_duplicates | ~5 min | Background |
| 3 | split_data.py | ~1 min | Synchronous OK |
| 4 | cpr_v7.4_specialist_gbm_trainer.py | ~30-60 min | Background |
| 5 | backtest + analyze_performance + backtest_final | ~15-25 min | Background |
...
TaskOutput(task_id="xxx", block=True, timeout=600000)
```
...
|---------|------|---------|
| V8.0 | 2024 | Current stable version with GBM specialist |
| V9.0+ | 2025 | 10-agent team structure, Opus 4.5 integration, folder usage rules |
