...
KELLY_FRACTION = 0.25
EDGE_THRESHOLD_MIN = 0.001 # Bet if edge is > 2%
EDGE_THRESHOLD_MAX = 0.084 # Bet if edge is < 10%
...
try:
    ...
    # --- NEW: Recreate Advantage Features for the Test Set ---
    ...
    print("Advantage features created for the test set.")
    ...
    backtest_df = backtest_df.loc[aligned_indices]
    ...
    print("\n--- Running Final Back-test Simulation ---")
