...
ODDS_FILE = "historical_odds_v7.1.csv"
OUTPUT_FILE = "final_dataset_v7.1.csv"
...
try:
    ...
    df_final = pd.merge(df_features, kickoff_odds, on='Match ID', how='inner')
    ...
    print(f"\n✅ Final v7.0 dataset created successfully!")
    print(f" -> {OUTPUT_FILE}")
